...
const Legend = ({
    ...
    const { ZONING_CAT_INFO, ZONING_ORDER, LAYER_STYLES } = CONSTANTS;
    ...
    return (
        <div
            className={`absolute top-16 md:top-24 right-4 md:right-20 z-legend w-[calc(100%-2rem)] md:w-64 glass-panel rounded-xl flex flex-col transition-all duration-300 ease-in-out ${visibilityClasses}`}
        ...
        >
            ...
            <div className="flex items-center justify-between p-3 border-b border-gray-100 bg-white/50 rounded-t-lg">
                <div className="flex items-center gap-2">
                    ...
                    {Icons.Map ? <Icons.Map className="h-4 w-4 text-guinda" /> : (
            ...
            <div className="overflow-y-auto p-3 space-y-4 custom-scrollbar">
                ...
                <div className="space-y-1.5">
                    <h4 className="text-[10px] font-bold text-gray-600 uppercase tracking-wider mb-1">Mapa Base</h4>
                    <div className="flex gap-2">
                        ...
                        <button
                            type="button"
                            aria-pressed={activeBaseLayer === 'STREETS'}
                ...
                <div className="space-y-2">
                    <h4 className="text-[10px] font-bold text-gray-600 uppercase tracking-wider mb-1">Zonificación Primaria</h4>
                    ...
                    >
                        ...
                        <div onClick={(e) => e.stopPropagation()}>
                            <ToggleSwitch
                                ...
                                ariaLabel="Mostrar u ocultar la capa Suelo de Conservación"
                                size="sm"
                            />
                        </div>
                    </div>
                ...
                <div className="space-y-2 pl-4 border-l-2 border-gray-100 ml-1">
                    ...
                    >
                        <h4 className="text-[10px] font-bold text-gray-600 uppercase tracking-wider leading-tight select-none">
                        ...
                        <div className="flex-shrink-0 pt-0.5" onClick={(e) => e.stopPropagation()}>
                            <ToggleSwitch
                                ...
                                ariaLabel="Mostrar u ocultar la Zonificación PGOEDF 2000"
                                size="sm"
                            />
                        </div>
                    </div>
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex flex-col leading-none">
                                                ...
                                                <span className="text-[11px] text-gray-500 select-none">{info.desc}</span>
                                            </div>
                                        </div>
                                        <div onClick={(e) => e.stopPropagation()}>
                                            <ToggleSwitch
                                                ...
                                                ariaLabel={`Mostrar u ocultar ${info.label}`}
                                                size="sm"
                                            />
                                        </div>
                                    </div>
                ...
                <div className="space-y-2 pt-2 border-t border-gray-100">
                    <h4 className="text-[10px] font-bold text-gray-600 uppercase tracking-wider mb-1">Áreas Naturales Protegidas</h4>
                    ...
                    >
                        ...
                        <div onClick={(e) => e.stopPropagation()}>
                            <ToggleSwitch
                                ...
                                ariaLabel="Mostrar u ocultar los Polígonos ANP"
                                size="sm"
                            />
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <div onClick={(e) => e.stopPropagation()}>
                                    <ToggleSwitch
                                        ...
                                        ariaLabel="Mostrar u ocultar la Zonificación Interna ANP"
                                        size="sm"
                                    />
                                </div>
                            </div>
                ...
                <div className="pt-3 border-t border-gray-100 mt-2">
                    <h4 className="text-[10px] font-bold text-gray-600 uppercase tracking-wider mb-2">Contexto Regional</h4>
